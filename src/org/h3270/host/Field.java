...
public class Field {
    ...
    public static final byte ATTR_NOT_RENDERED = ATTR_PROTECTED | ATTR_DISP_1
            | ATTR_DISP_2;
    ...
    /**
     * Returns the x coordinate (column) at which this Field ends. Column
     * numbers start at zero. The number returned is the position of the Field's
     * last character, not of the control character that terminates the Field.
     */
    public int getEndX() {
        return endx;
    }
     ...
     * preceding or next line, respectively, then those lines are not incluced
     * in the height count -- only the actual text of the Field counts.
     */
    ...
    /**
     * Returns the current value of this Field. This does not include the
     * control character that starts the field, and it does not include leading
     * or trailing newlines. If this Field is a multi-line field, the individual
     ...
     * methods prepends a blank for the opening field attribute, and adds
     * newline characters at the beginning and the end as needed. Calling this
     * method for each Field of a Screen, and concatenating the results, creates
     * a full printable, textual representation of the screen.
     */
