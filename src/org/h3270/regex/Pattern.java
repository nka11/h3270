...
/**
 * An abstract version of class java.util.regex.Pattern that allows for
 * different implementations to be plugged in. References to CharSequence have
 * been replaced with overloaded methods.
 * 
 * When you create an instance via Pattern.compile(), this class selects either
